...
export let projectNewData =  [
    {
        ...
        subtasks: [
            ...
            { TaskID: 3, TaskName: 'Defining target audience', StartDate: new Date('04/02/2019'), Duration: 3, resources: [3] },
            {
                ...
                Predecessor: '2', Progress: 30, isManual : true, resources: [4]
            },
        ]
    },
    {
        TaskID: 5, TaskName: 'Concept approval', StartDate: new Date('04/02/2019'), Duration: 3, Predecessor: '3,4', resources: [1],
        Indicators: [
            {
                'date': '04/12/2019',
                'name': 'Design Phase',
    ...
    },
    {
        ...
        subtasks: [
                ...
                subtasks: [
                    {
                        ...
                        Predecessor: '5', Progress: 30, resources: [5]
                    },
            ...
            },
            {
                ...
                Predecessor: '7, 8', Progress: 30, isManual : true, resources: [4]
            },
            ...
            },
            {
                ...
                subtasks: [
                    ...
                    },
                    {
                        ...
                        Duration: 2, Predecessor: '22', isManual : true,
                    },
